...
import { Serializable, serializeEntryFunctionBytesCompat } from "../serializer.js";
 ...
 * @category BCS
 */
export class MoveVector extends Serializable {
    values;
    /**
     ...
     */
    static I8(values) {
        return new MoveVector(values.map((v) => new I8(v)));
    }
    /**
     ...
     */
    static I16(values) {
        return new MoveVector(values.map((v) => new I16(v)));
    }
    /**
     ...
     */
    static I32(values) {
        return new MoveVector(values.map((v) => new I32(v)));
    }
    /**
     ...
     */
    static I64(values) {
        return new MoveVector(values.map((v) => new I64(v)));
    }
    /**
     ...
     */
    static I128(values) {
        return new MoveVector(values.map((v) => new I128(v)));
    }
    /**
     ...
     */
    static I256(values) {
        return new MoveVector(values.map((v) => new I256(v)));
    }
    /**
 ...
 * @category BCS
 */
export class Serialized extends Serializable {
    value;
    constructor(value) {
        super();
...
export class MoveOption extends Serializable {
    vec;
    value;
    constructor(value) {
        super();
     ...
     */
    static U8(value) {
        return new MoveOption(value !== null && value !== undefined ? new U8(value) : undefined);
    }
    /**
     ...
     */
    static U16(value) {
        return new MoveOption(value !== null && value !== undefined ? new U16(value) : undefined);
    }
    /**
     ...
     */
    static U32(value) {
        return new MoveOption(value !== null && value !== undefined ? new U32(value) : undefined);
    }
    /**
     ...
     */
    static U64(value) {
        return new MoveOption(value !== null && value !== undefined ? new U64(value) : undefined);
    }
    /**
     ...
     */
    static U128(value) {
        return new MoveOption(value !== null && value !== undefined ? new U128(value) : undefined);
    }
    /**
     ...
     */
    static U256(value) {
        return new MoveOption(value !== null && value !== undefined ? new U256(value) : undefined);
    }
    /**
     ...
     */
    static Bool(value) {
        return new MoveOption(value !== null && value !== undefined ? new Bool(value) : undefined);
    }
    /**
     ...
     */
    static I8(value) {
        return new MoveOption(value !== null && value !== undefined ? new I8(value) : undefined);
    }
    /**
     ...
     */
    static I16(value) {
        return new MoveOption(value !== null && value !== undefined ? new I16(value) : undefined);
    }
    /**
     ...
     */
    static I32(value) {
        return new MoveOption(value !== null && value !== undefined ? new I32(value) : undefined);
    }
    /**
     ...
     */
    static I64(value) {
        return new MoveOption(value !== null && value !== undefined ? new I64(value) : undefined);
    }
    /**
     ...
     */
    static I128(value) {
        return new MoveOption(value !== null && value !== undefined ? new I128(value) : undefined);
    }
    /**
     ...
     */
    static I256(value) {
        return new MoveOption(value !== null && value !== undefined ? new I256(value) : undefined);
    }
    /**
