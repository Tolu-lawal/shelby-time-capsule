...
import { type AnyNumber, type GasEstimation, type HexInput, type PaginationArgs, type TransactionResponse, WaitForTransactionOptions, CommittedTransactionResponse, Block } from "../types/index.js";
 ...
 * @group Implementation
 */
export declare function getGasPriceEstimation(args: {
    aptosConfig: AptosConfig;
 ...
 * @group Implementation
 */
export declare function getTransactionByVersion(args: {
    aptosConfig: AptosConfig;
 ...
 * @group Implementation
 */
export declare function getTransactionByHash(args: {
    aptosConfig: AptosConfig;
 ...
 * @group Implementation
 */
export declare function isTransactionPending(args: {
    aptosConfig: AptosConfig;
    transactionHash: HexInput;
}): Promise<boolean>;
/**
 ...
 * @group Implementation
 */
export declare function longWaitForTransaction(args: {
    aptosConfig: AptosConfig;
    transactionHash: HexInput;
}): Promise<TransactionResponse>;
/**
 ...
 * @group Implementation
 */
export declare function waitForTransaction(args: {
    aptosConfig: AptosConfig;
    transactionHash: HexInput;
 ...
 * @group Implementation
 */
export declare function waitForIndexer(args: {
    aptosConfig: AptosConfig;
 ...
 * @group Implementation
 */
export declare function getBlockByVersion(args: {
    aptosConfig: AptosConfig;
    ledgerVersion: AnyNumber;
    options?: {
 ...
 * @group Implementation
 */
export declare function getBlockByHeight(args: {
    aptosConfig: AptosConfig;
