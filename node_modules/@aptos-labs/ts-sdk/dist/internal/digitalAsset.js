...
import { MoveAbility, } from "../types/index.js";
import { GetCollectionData, GetCurrentTokenOwnership, GetTokenActivity, GetTokenData, } from "../types/generated/queries.js";
...
import { checkOrConvertArgument, objectStructTag, parseTypeTag, stringStructTag, TypeTagAddress, TypeTagBool, TypeTagGeneric, TypeTagStruct, TypeTagU64, TypeTagVector, } from "../transactions/index.js";
 ...
 * @group Implementation
 */
export async function createCollectionTransaction(args) {
...
export async function mintDigitalAssetTransaction(args) {
    const { aptosConfig, options, creator, collection, description, name, uri, propertyKeys, propertyTypes, propertyValues, } = args;
...
export async function mintSoulBoundTransaction(args) {
    const { aptosConfig, account, collection, description, name, uri, recipient, propertyKeys, propertyTypes, propertyValues, options, } = args;
...
const setDigitalAssetDescriptionAbi = {
    typeParameters: [{ constraints: [MoveAbility.KEY] }],
...
const addDigitalAssetPropertyAbi = {
    typeParameters: [{ constraints: [MoveAbility.KEY] }],
    parameters: [
...
export async function addDigitalAssetPropertyTransaction(args) {
    const { aptosConfig, creator, propertyKey, propertyType, propertyValue, digitalAssetAddress, digitalAssetType, options, } = args;
    return generateTransaction({
        aptosConfig,
        sender: creator.accountAddress,
        data: {
...
const removeDigitalAssetPropertyAbi = {
    typeParameters: [{ constraints: [MoveAbility.KEY] }],
    parameters: [new TypeTagStruct(objectStructTag(new TypeTagGeneric(0))), new TypeTagStruct(stringStructTag())],
};
/**
...
const updateDigitalAssetPropertyAbi = {
    typeParameters: [{ constraints: [MoveAbility.KEY] }],
    parameters: [
        new TypeTagStruct(objectStructTag(new TypeTagGeneric(0))),
        new TypeTagStruct(stringStructTag()),
...
const addDigitalAssetTypedPropertyAbi = {
...
const updateDigitalAssetTypedPropertyAbi = {
    typeParameters: [{ constraints: [MoveAbility.KEY] }, { constraints: [] }],
    parameters: [
        new TypeTagStruct(objectStructTag(new TypeTagGeneric(0))),
        new TypeTagStruct(stringStructTag()),
