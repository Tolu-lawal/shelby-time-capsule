...
import { AnyNumber, GetCollectionDataResponse, GetCurrentTokenOwnershipResponse, GetOwnedTokensResponse, GetTokenActivityResponse, GetTokenDataResponse, MoveStructId, OrderByArg, PaginationArgs, TokenStandardArg, WhereArg } from "../types/index.js";
import { CurrentCollectionsV2BoolExp } from "../types/generated/types.js";
 ...
 * @group Implementation
 */
export declare function getDigitalAssetData(args: {
 ...
 * @group Implementation
 */
export declare function getCurrentDigitalAssetOwnership(args: {
    aptosConfig: AptosConfig;
    digitalAssetAddress: AccountAddressInput;
 ...
 * @group Implementation
 */
export declare function getOwnedDigitalAssets(args: {
    aptosConfig: AptosConfig;
 ...
 * @group Implementation
 */
export declare function getDigitalAssetActivity(args: {
    aptosConfig: AptosConfig;
    digitalAssetAddress: AccountAddressInput;
    options?: PaginationArgs & OrderByArg<GetTokenActivityResponse[0]>;
 ...
 * @group Implementation
 */
export declare function createCollectionTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    description: string;
    name: string;
 ...
 * @group Implementation
 */
export declare function getCollectionData(args: {
    aptosConfig: AptosConfig;
 ...
 * @group Implementation
 */
export declare function getCollectionDataByCreatorAddressAndCollectionName(args: {
    aptosConfig: AptosConfig;
 ...
 * @group Implementation
 */
export declare function getCollectionDataByCreatorAddress(args: {
    aptosConfig: AptosConfig;
    creatorAddress: AccountAddressInput;
    options?: TokenStandardArg & PaginationArgs;
}): Promise<GetCollectionDataResponse>;
 ...
 * @group Implementation
 */
export declare function getCollectionDataByCollectionId(args: {
    aptosConfig: AptosConfig;
 ...
 * @group Implementation
 */
export declare function getCollectionId(args: {
    aptosConfig: AptosConfig;
    creatorAddress: AccountAddressInput;
    collectionName: string;
 ...
 * @group Implementation
 */
export declare function mintDigitalAssetTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    collection: string;
    description: string;
 ...
 * @group Implementation
 */
export declare function transferDigitalAssetTransaction(args: {
    aptosConfig: AptosConfig;
    sender: Account;
    digitalAssetAddress: AccountAddressInput;
 ...
 * @group Implementation
 */
export declare function mintSoulBoundTransaction(args: {
    aptosConfig: AptosConfig;
    account: Account;
    collection: string;
    description: string;
 ...
 * @group Implementation
 */
export declare function burnDigitalAssetTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    digitalAssetAddress: AccountAddressInput;
    digitalAssetType?: MoveStructId;
 ...
 * @group Implementation
 */
export declare function freezeDigitalAssetTransferTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    digitalAssetAddress: AccountAddressInput;
    digitalAssetType?: MoveStructId;
 ...
 * @group Implementation
 */
export declare function unfreezeDigitalAssetTransferTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    digitalAssetAddress: AccountAddressInput;
    digitalAssetType?: MoveStructId;
 ...
 * @group Implementation
 */
export declare function setDigitalAssetDescriptionTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    description: string;
    digitalAssetAddress: AccountAddressInput;
 ...
 * @group Implementation
 */
export declare function setDigitalAssetNameTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    name: string;
    digitalAssetAddress: AccountAddressInput;
 ...
 * @group Implementation
 */
export declare function setDigitalAssetURITransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    uri: string;
    digitalAssetAddress: AccountAddressInput;
 ...
 * @group Implementation
 */
export declare function addDigitalAssetPropertyTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    propertyKey: string;
 ...
 * @group Implementation
 */
export declare function removeDigitalAssetPropertyTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    propertyKey: string;
    digitalAssetAddress: AccountAddressInput;
 ...
 * @group Implementation
 */
export declare function updateDigitalAssetPropertyTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    propertyKey: string;
    propertyType: PropertyType;
 ...
 * @group Implementation
 */
export declare function addDigitalAssetTypedPropertyTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    propertyKey: string;
    propertyType: PropertyType;
 ...
 * @group Implementation
 */
export declare function updateDigitalAssetTypedPropertyTransaction(args: {
    aptosConfig: AptosConfig;
    creator: Account;
    propertyKey: string;
    propertyType: PropertyType;
...
export {};
//# sourceMappingURL=digitalAsset.d.ts.map