...
export class Hex {
    ...
    static fromHexString(str) {
        ...
        if (input.length === 0) {
            throw new ParsingError("Hex string is too short, must be at least 1 char long, excluding the optional leading 0x.", HexInvalidReason.TOO_SHORT);
        }
        if (input.length % 2 !== 0) {
...
export const hexToAsciiString = (hex) => new TextDecoder().decode(Hex.fromHexInput(hex).toUint8Array());
