 ...
 */
export const createObjectAddress = (creatorAddress, seed) => {
 ...
 * @category Account (On-Chain Model)
 */
export const createResourceAddress = (creatorAddress, seed) => {
    const creatorBytes = creatorAddress.bcsToBytes();
    const seedBytes = typeof seed === "string" ? TEXT_ENCODER.encode(seed) : seed;
 ...
 * @category Account (On-Chain Model)
 */
export const createUserDerivedObjectAddress = (sourceAddress, deriveFromAddress) => {
 ...
 * @category Account (On-Chain Model)
 */
export const createTokenAddress = (creatorAddress, collectionName, tokenName) => {
