import { AnyPublicKeyVariant, AnySignatureVariant, SigningScheme as AuthenticationKeyScheme, } from "../../types/index.js";
...
import { detectPublicKeyVariant, detectSignatureVariant, getPublicKeyDeserializer, getSignatureDeserializer, } from "./anyKeyRegistry.js";
/**
...
export class AnySignature extends Signature {
    ...
    toUint8Array() {
        ...
        console.warn("[Aptos SDK] Calls to AnySignature.toUint8Array() will soon return the underlying signature bytes. " +
            "Use AnySignature.bcsToBytes() instead.");
        return this.bcsToBytes();
    }
    // endregion
