...
import { PrivateKeyVariants } from "../../types/index.js";
...
export class Secp256k1PublicKey extends PublicKey {
    ...
    constructor(hexInput) {
        ...
        if (length === Secp256k1PublicKey.LENGTH) {
            ...
            throw new Error(`PublicKey length should be ${Secp256k1PublicKey.LENGTH} or ${Secp256k1PublicKey.COMPRESSED_LENGTH}, received ${length}`);
        }
    }
    // region PublicKey
    /**
