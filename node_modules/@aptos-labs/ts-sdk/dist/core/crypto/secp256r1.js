...
import { PrivateKeyVariants, SigningScheme as AuthenticationKeyScheme, AnyPublicKeyVariant, } from "../../types/index.js";
...
export class Secp256r1PublicKey extends PublicKey {
    ...
    constructor(hexInput) {
        ...
        if (keyLength !== Secp256r1PublicKey.LENGTH && keyLength !== Secp256r1PublicKey.COMPRESSED_LENGTH) {
            throw new Error(`PublicKey length should be ${Secp256r1PublicKey.LENGTH} or ${Secp256r1PublicKey.COMPRESSED_LENGTH}, received ${keyLength}`);
        }
...
export class WebAuthnSignature extends Signature {
    ...
    authenticatorData;
    clientDataJSON;
    constructor(signature, authenticatorData, clientDataJSON) {
        super();
