...
export class OneTimePad extends Serializable {
    ...
    static fromSourceBytes(otpSource) {
...
export function hmacKdf(otpSource) {
    return hkdf(sha256, otpSource, HKDF_SALT, new Uint8Array(), 32);
}
export function getRandomFr() {
 ...
 */
export function hashToFr(input, dst = new Uint8Array(0)) {
    const options = {
        DST: dst,
        expand: "xmd",
        hash: sha256,
...
export function hashG2Element(g2Element) {
