...
import { getRandomFr, hashG2Element, hashToFr, ID_HASH_DST, OneTimePad, SymmetricCiphertext, SymmetricKey, } from "./symmetric.js";
/**
...
export class BIBECiphertext extends Serializable {
    ...
    paddedKey;
    symmetricCiphertext;
    constructor(id, ctG2, paddedKey, symmetricCiphertext) {
        super();
        if (ctG2.length !== 3) {
...
export class Ciphertext extends Serializable {
    ...
    associatedDataBytes;
    signature;
    constructor(vk, bibeCt, associatedDataBytes, signature) {
        super();
        if (vk.length !== 32) {
...
export class EncryptionKey extends Serializable {
    ...
    bibeEncrypt(plaintext, id) {
        ...
        const g1Point = hashedEncryptionKey.multiply(r[1]);
