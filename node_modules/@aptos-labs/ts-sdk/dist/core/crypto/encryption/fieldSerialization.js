...
export function bigintToLEBytesInternal(val, numBytes) {
    const ret = [];
    let v = val;
...
export function bigintToLEBytesFr(val) {
    return bigintToLEBytesInternal(val, 32);
}
export function bigintToLEBytesFq(val) {
...
export function leBytesToFp12(bytes) {
...
//# sourceMappingURL=fieldSerialization.js.map