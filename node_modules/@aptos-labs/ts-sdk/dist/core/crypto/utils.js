 ...
 */
export const convertSigningMessage = (message) => {
...
export const accountPublicKeyToBaseAccountPublicKey = (publicKey) => {
...
export const accountPublicKeyToSigningScheme = (publicKey) => {
