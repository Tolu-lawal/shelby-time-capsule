...
import { NetworkToNodeAPI, NetworkToFaucetAPI, NetworkToIndexerAPI, Network, NetworkToPepperAPI, NetworkToProverAPI, } from "../utils/apiEndpoints.js";
...
export class AptosConfig {
    ...
    constructor(settings) {
        ...
        if (isBun() && settings?.clientConfig?.http2 !== false) {
            console.warn("[Aptos SDK] Bun does not fully support HTTP/2, which is enabled by default in this SDK. " +
    ...
    getRequestUrl(apiType) {
        switch (apiType) {
            case AptosApiType.FULLNODE:
                ...
                if (this.network === Network.CUSTOM)
                    throw new Error("Please provide a custom full node url");
                return NetworkToNodeAPI[this.network];
            case AptosApiType.FAUCET:
                if (this.faucet !== undefined)
                    return this.faucet;
                if (this.network === Network.TESTNET) {
                    throw new Error("There is no way to programmatically mint testnet APT, you must use the minting site at https://aptos.dev/network/faucet");
                }
     ...
     * @group Client
     */
    setIgnoreTransactionSubmitter(ignore) {
...
//# sourceMappingURL=aptosConfig.js.map