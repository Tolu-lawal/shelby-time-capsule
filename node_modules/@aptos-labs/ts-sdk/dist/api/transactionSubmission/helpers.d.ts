 ...
 */
export declare function validateFeePayerDataOnSubmission(config: AptosConfig, args: {
 ...
 * @group Implementation
 */
export declare function ValidateFeePayerDataOnSimulation(target: unknown, propertyKey: string, descriptor: PropertyDescriptor): PropertyDescriptor;
