...
import { addAuthenticationFunctionTransaction, removeAuthenticationFunctionTransaction, removeDispatchableAuthenticatorTransaction, } from "../../internal/abstraction.js";
import { view } from "../../internal/view.js";
import { TypeTagAddress } from "../../transactions/index.js";
...
export class AccountAbstraction {
     ...
     */
    async addAuthenticationFunctionTransaction(args) {
     ...
     */
    async removeAuthenticationFunctionTransaction(args) {
        const { accountAddress, authenticationFunction, options } = args;
     ...
     */
    async removeDispatchableAuthenticatorTransaction(args) {
     ...
     */
    async getAuthenticationFunction(args) {
        ...
        if (functionInfoOption.length === 0)
            return undefined;
     ...
     */
    isAccountAbstractionEnabled = async (args) => {
        ...
        return (functionInfos?.some((functionInfo) => AccountAddress.fromString(moduleAddress).equals(functionInfo.moduleAddress) &&
            moduleName === functionInfo.moduleName &&
            functionName === functionInfo.functionName) ?? false);
    };
    /**
     ...
     */
    enableAccountAbstractionTransaction = this.addAuthenticationFunctionTransaction;
    /**
     ...
     */
    disableAccountAbstractionTransaction = async (args) => {
        const { accountAddress, authenticationFunction, options } = args;
