...
import { getExpiration, getOwnerAddress, registerName, getPrimaryName, setPrimaryName, getTargetAddress, setTargetAddress, clearTargetAddress, renewDomain, getName, getAccountDomains, getAccountSubdomains, getAccountNames, getDomainSubdomains, } from "../internal/ans.js";
/**
...
export class ANS {
     ...
     * @group ANS
     */
    async getAccountSubdomains(args) {
     ...
     * @group ANS
     */
    async getDomainSubdomains(args) {
