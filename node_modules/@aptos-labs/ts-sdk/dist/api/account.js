...
export class Account {
    ...
    async getAccountCoinAmount(args) {
        ...
        if (coinType === undefined && faMetadataAddress !== undefined) {
            coinAssetType = await memoizeAsync(async () => {
                try {
                    const pairedCoinTypeStruct = (await view({
                        aptosConfig: this.config,
                ...
                return undefined;
            }, `coin-mapping-${faMetadataAddress.toString()}`, 1000 * 60 * 5)();
        }
        let faAddress;
        if (coinType !== undefined && faMetadataAddress !== undefined) {
