 ...
 * @category Client
 */
export async function postAptosFullNode(options) {
 ...
 * @category Client
 */
export async function postAptosIndexer(options) {
    const { aptosConfig } = options;
    return post({
        ...options,
 ...
 * @category Client
 */
export async function postAptosFaucet(options) {
    const { aptosConfig } = options;
 ...
 * @category Client
 */
export async function postAptosPepperService(options) {
    return post({ ...options, type: AptosApiType.PEPPER });
}
/**
 ...
 * @category Client
 */
export async function postAptosProvingService(options) {
    return post({ ...options, type: AptosApiType.PROVER });
}
