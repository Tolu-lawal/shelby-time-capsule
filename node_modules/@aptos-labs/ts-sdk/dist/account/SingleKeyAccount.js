...
import { SigningScheme, SigningSchemeInput } from "../types/index.js";
import { AccountAddress } from "../core/accountAddress.js";
import { AnyPublicKey, AnySignature, Ed25519PrivateKey, Secp256k1PrivateKey, } from "../core/crypto/index.js";
import { generateSigningMessageForTransaction } from "../transactions/transactionBuilder/signingMessage.js";
export function isSingleKeySigner(obj) {
    return (typeof obj === "object" && obj !== null && "getAnyPublicKey" in obj && typeof obj.getAnyPublicKey === "function");
}
/**
...
export class SingleKeyAccount {
    ...
    // endregion
    static fromEd25519Account(account) {
