...
import { generateSigningMessage, generateSigningMessageForTransaction, } from "../transactions/transactionBuilder/signingMessage.js";
...
export class AbstractedAccount extends Account {
    ...
    static generateAccountAbstractionMessage(message, functionInfo) {
    ...
    signWithAuthenticator(message) {
        ...
        return new AccountAuthenticatorAbstraction(this.authenticationFunction, sha3_256(messageBytes), this.sign(sha3_256(messageBytes)).toUint8Array());
    }
    signTransactionWithAuthenticator(transaction) {
        const message = AbstractedAccount.generateAccountAbstractionMessage(generateSigningMessageForTransaction(transaction), this.authenticationFunction);
...
//# sourceMappingURL=AbstractedAccount.js.map