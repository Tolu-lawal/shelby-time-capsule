...
import { getIssAudAndUidVal } from "../core/crypto/keyless.js";
...
export class FederatedKeylessAccount extends AbstractKeylessAccount {
     ...
     */
    static create(args) {
        const { address, proof, jwt, ephemeralKeyPair, pepper, jwkAddress, uidKey = "sub", proofFetchCallback, verificationKey, verificationKeyHash, } = args;
...
//# sourceMappingURL=FederatedKeylessAccount.js.map