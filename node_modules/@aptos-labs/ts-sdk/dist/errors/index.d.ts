...
export declare enum KeylessErrorCategory {
    API_ERROR = 0,
...
export declare enum KeylessErrorResolutionTip {
...
export declare enum KeylessErrorType {
...
export declare class KeylessError extends Error {
