...
export class AccountSequenceNumber {
            ...
            if (this.currentNumber - this.lastUncommittedNumber >= this.maximumInFlight) {
                ...
                while (this.currentNumber - this.lastUncommittedNumber >= this.maximumInFlight) {
                    ...
                    if (nowInSeconds() - startTime > this.maxWaitTime) {
                        console.warn(`Waited over 30 seconds for a transaction to commit, re-syncing ${this.account.accountAddress.toString()}`);
                        await this.initialize();
                    }
                    else {
                        await this.update();
     ...
     */
    async synchronize() {
        if (this.lastUncommittedNumber === this.currentNumber)
            return;
        while (this.lock) {
            await sleep(this.sleepTime);
        }
...
//# sourceMappingURL=accountSequenceNumber.js.map