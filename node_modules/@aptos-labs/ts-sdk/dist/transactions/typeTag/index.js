 ...
 */
export class TypeTag extends Serializable {
    /**
 ...
 * @category Transactions
 */
export function aptosCoinStructTag() {
 ...
 * @category Transactions
 */
export function stringStructTag() {
 ...
 * @category Transactions
 */
export function optionStructTag(typeArg) {
 ...
 * @category Transactions
 */
export function objectStructTag(typeArg) {
