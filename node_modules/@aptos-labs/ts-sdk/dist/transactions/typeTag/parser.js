...
import { StructTag, TypeTagAddress, TypeTagBool, TypeTagGeneric, TypeTagReference, TypeTagSigner, TypeTagStruct, TypeTagU128, TypeTagU16, TypeTagU256, TypeTagU32, TypeTagU64, TypeTagU8, TypeTagI8, TypeTagI16, TypeTagI32, TypeTagI64, TypeTagI128, TypeTagI256, TypeTagVector, } from "./index.js";
 ...
 * @category Transactions
 */
export var TypeTagParserErrorType;
(function (TypeTagParserErrorType) {
    ...
    TypeTagParserErrorType["MissingTypeArgument"] = "no type argument before ','";
    ...
    TypeTagParserErrorType["InvalidAddress"] = "struct address must be valid";
 ...
 * @category Transactions
 */
export function parseTypeTag(typeStr, options) {
...
function parseTypeTagInner(str, types, allowGenerics) {
    ...
    switch (trimmedStr.toLowerCase()) {
        ...
        default: {
            ...
            return new TypeTagStruct(new StructTag(address, new Identifier(structParts[1]), new Identifier(structParts[2]), types));
        }
    }
}
