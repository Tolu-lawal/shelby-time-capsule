...
import { RAW_TRANSACTION_SALT, RAW_TRANSACTION_WITH_DATA_SALT, TEXT_ENCODER } from "../../utils/const.js";
 ...
 * @category Transactions
 */
export function deriveTransactionType(transaction) {
    if (transaction.feePayerAddress) {
        return new FeePayerRawTransaction(transaction.rawTransaction, transaction.secondarySignerAddresses ?? [], transaction.feePayerAddress);
    }
 ...
 * @category Transactions
 */
export function generateSigningMessage(bytes, domainSeparator) {
    ...
    hash.update(TEXT_ENCODER.encode(domainSeparator));
 ...
 * @category Transactions
 */
export function generateSigningMessageForSerializable(serializable) {
 ...
 * @category Transactions
 */
export function generateSigningMessageForTransaction(transaction) {
