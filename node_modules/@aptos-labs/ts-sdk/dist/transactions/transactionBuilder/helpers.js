 ...
 * @category Transactions
 */
export function convertNumber(arg) {
    if (isNumber(arg)) {
        return arg;
    }
    if (isString(arg) && arg !== "") {
 ...
 * @category Transactions
 */
export function isLargeNumber(arg) {
 ...
 * @category Transactions
 */
export function isEmptyOption(arg) {
 ...
 * @category Transactions
 */
export function isEncodedEntryFunctionArgument(arg) {
    return (
    /**
 ...
 * @category Transactions
 */
export function isBcsAddress(arg) {
 ...
 * @category Transactions
 */
export function isBcsString(arg) {
 ...
 * @category Transactions
 */
export function isBcsFixedBytes(arg) {
 ...
 * @category Transactions
 */
export function isScriptDataInput(arg) {
 ...
 * @category Transactions
 */
export function throwTypeMismatch(expectedType, position) {
 ...
 * @category Transactions
 */
export function findFirstNonSignerArg(functionAbi) {
