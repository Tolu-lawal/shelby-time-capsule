...
import { AccountAddressInput, PublicKey } from "../../core/index.js";
import { AccountAuthenticatorEd25519, AccountAuthenticatorMultiKey, AccountAuthenticatorNoAccountAuthenticator, AccountAuthenticatorSingleKey } from "../authenticator/account.js";
import { EntryFunction, RawTransaction, TransactionInnerPayload, TransactionPayloadEntryFunction, TransactionPayloadMultiSig, TransactionPayloadScript } from "../instances/index.js";
import { AnyTransactionPayloadInstance, InputGenerateMultiAgentRawTransactionArgs, InputGenerateSingleSignerRawTransactionArgs, InputGenerateTransactionOptions, InputScriptData, InputSimulateTransactionData, InputMultiSigDataWithRemoteABI, InputEntryFunctionDataWithRemoteABI, InputSubmitTransactionData, InputEntryFunctionDataWithABI, InputMultiSigDataWithABI, InputViewFunctionDataWithRemoteABI, InputViewFunctionDataWithABI } from "../types.js";
 ...
 * @category Transactions
 */
export declare function generateViewFunctionPayload(args: InputViewFunctionDataWithRemoteABI): Promise<EntryFunction>;
/**
 ...
 * @category Transactions
 */
export declare function generateViewFunctionPayloadWithABI(args: InputViewFunctionDataWithABI): EntryFunction;
/**
...
export declare function convertPayloadToInnerPayload(payload: AnyTransactionPayloadInstance, replayProtectionNonce?: bigint): TransactionInnerPayload;
/**
 ...
 * @category Transactions
 */
export declare function generateSignedTransactionForSimulation(args: InputSimulateTransactionData): Promise<Uint8Array>;
/**
 * @group Implementation
 * @category Transactions
 */
export declare function getAuthenticatorForSimulation(publicKey?: PublicKey): Promise<AccountAuthenticatorEd25519 | AccountAuthenticatorSingleKey | AccountAuthenticatorMultiKey | AccountAuthenticatorNoAccountAuthenticator>;
/**
