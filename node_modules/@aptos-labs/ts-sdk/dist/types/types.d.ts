 ...
 */
export declare enum MultiSigTransactionPayloadVariants {
    EntryFunction = 0,
    Script = 1
}
/**
 ...
 * {@link https://github.com/aptos-labs/aptos-core/blob/main/types/src/transaction/mod.rs#L478}
 */
export declare enum TransactionInnerPayloadVariants {
    V1 = 0
}
/**
 ...
 */
export declare enum TransactionExecutableVariants {
    Script = 0,
    EntryFunction = 1,
    Empty = 2,
    Encrypted = 3
 ...
 */
export declare enum TransactionExtraConfigVariants {
    V1 = 0
}
/**
 ...
 */
export declare enum PrivateKeyVariants {
    Ed25519 = "ed25519",
    Secp256k1 = "secp256k1",
    Secp256r1 = "secp256r1"
}
...
export declare function anyPublicKeyVariantToString(variant: AnyPublicKeyVariant): string;
/**
 ...
 */
export type CommittedTransactionResponse = UserTransactionResponse | GenesisTransactionResponse | BlockMetadataTransactionResponse | StateCheckpointTransactionResponse | ValidatorTransactionResponse | BlockEpilogueTransactionResponse;
/**
 ...
 */
export declare function isValidatorTransactionResponse(response: TransactionResponse): response is ValidatorTransactionResponse;
/**
 ...
 */
export declare function isBlockEpilogueTransactionResponse(response: TransactionResponse): response is BlockEpilogueTransactionResponse;
/**
 ...
 */
export type EncryptedTransactionPayloadResponse = EncryptedEncryptedTransactionPayloadResponse | DecryptedEncryptedTransactionPayloadResponse;
/**
 * The payload for a transaction response, which can be an entry function, script, multisig, or encrypted payload.
 */
export type TransactionPayloadResponse = EntryFunctionPayloadResponse | ScriptPayloadResponse | MultisigPayloadResponse | EncryptedTransactionPayloadResponse;
/**
 ...
 */
export type TransactionSignature = TransactionEd25519Signature | TransactionSecp256k1Signature | TransactionMultiEd25519Signature | TransactionMultiAgentSignature | TransactionFeePayerSignature | TransactionSingleSenderSignature;
/**
 ...
 */
export declare function isEd25519Signature(signature: TransactionSignature): signature is TransactionEd25519Signature;
/**
 ...
 */
export declare function isSingleSenderSignature(signature: TransactionSignature): signature is TransactionSingleSenderSignature;
/**
 ...
 * arrays of MoveType.
 */
export type MoveType = boolean | string | MoveUint8Type | MoveUint16Type | MoveUint32Type | MoveUint64Type | MoveUint128Type | MoveUint256Type | MoveInt8Type | MoveInt16Type | MoveInt32Type | MoveInt64Type | MoveInt128Type | MoveInt256Type | MoveAddressType | MoveObjectType | MoveStructType | Array<MoveType>;
/**
 ...
 */
export type MoveValue = boolean | string | MoveUint8Type | MoveUint16Type | MoveUint32Type | MoveUint64Type | MoveUint128Type | MoveUint256Type | MoveInt8Type | MoveInt16Type | MoveInt32Type | MoveInt64Type | MoveInt128Type | MoveInt256Type | MoveAddressType | MoveObjectType | MoveStructId | MoveOptionType | Array<MoveValue>;
/**
