...
// node_modules/@aptos-labs/ts-sdk/dist/account/KeylessAccount.js
...
var KeylessAccount = class _KeylessAccount extends AbstractKeylessAccount {
   ...
   */
  static create(args) {
    const { address, proof, jwt, ephemeralKeyPair, pepper, uidKey = "sub", proofFetchCallback, verificationKey, verificationKeyHash } = args;
    ...
    return new _KeylessAccount({
      ...
      jwt,
      proofFetchCallback,
      verificationKeyHash: verificationKeyHash ?? (verificationKey ? verificationKey.hash() : void 0)
    });
  }
};
...
//# sourceMappingURL=chunk-XJVG5FLW.js.map
